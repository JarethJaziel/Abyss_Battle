...
void mostrarFeedback(player* jugador1, player* jugador2){
	...
	printf("\n\n=============================================\n");
	printf("          ESTAD�STICAS JUGADOR 1\n\n");
	printf("El jugador 1 realiz� %d disparos\n", jugador1->disparos);
	printf("El jugador 1 elimin� a %d soldados enemigos\n", (MAX_SOLDIER - soldadosActivos(jugador2)));
	printf("El jugador 1 se qued� con %d soldados\n\n", soldadosActivos(jugador1));
	printf("=============================================\n");
	printf("          ESTAD�STICAS JUGADOR 2\n\n");
	printf("El jugador 2 realiz� %d disparos\n", jugador2->disparos);
	printf("El jugador 2 elimin� a %d soldados enemigos\n", (MAX_SOLDIER - soldadosActivos(jugador1)));
	printf("El jugador 2 se qued� con %d soldados\n\n", soldadosActivos(jugador2));
    ...
    do {
    	...
    	switch(moment){
    		case 1:
    			...
    			printf("\tPara seleccionar la posici�n, presiona enter\n");
        ...
        Sleep(10);
    } while (keyMain != 27 && moment<=4); // '27' es el código ASCII para la tecla 'Escape'
